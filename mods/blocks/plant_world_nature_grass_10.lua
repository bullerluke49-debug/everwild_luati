...
create_plant("everwild:grass_10", "Grass 10", "plantlike", "plant_world_nature_grass_10.png", {oddly_breakable_by_hand = 3}, "everwild_items:ripped_grass_string", 3, {fill_ratio = 0.03})
...
drops("everwild:grass_10",item_drop_list)